...
import numpy as np
import os
from keras.layers import Input,Reshape, Conv2D, Flatten,Dense,Activation,MaxPooling2D,AlphaDropout
...
filepath = './model/ResNet_Model_72w.h5'
...
# model.load_weights(filepath)这个是载入模型
#model.predict(x)这个是预测
